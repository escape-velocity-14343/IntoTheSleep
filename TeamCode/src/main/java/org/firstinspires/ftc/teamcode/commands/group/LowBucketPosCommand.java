...
public class LowBucketPosCommand extends SequentialCommandGroup {
    ...
    public LowBucketPosCommand(ExtensionSubsystem extension, PivotSubsystem pivot, WristSubsystem wrist) {
        addCommands(
                ...
                new ParallelCommandGroup(
                        ...
                        new SequentialCommandGroup(
                                ...
                                new ExtendCommand(extension, SlideConstants.lowBucketPos).withTimeout(1000)
                        )
                ),
    ...
    public static LowBucketPosCommand newWithWristPos(ExtensionSubsystem extension, PivotSubsystem pivot, WristSubsystem wrist) {
