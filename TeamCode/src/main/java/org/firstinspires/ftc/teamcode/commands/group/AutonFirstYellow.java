...
public class AutonFirstYellow extends SequentialCommandGroup {
    public AutonFirstYellow(ExtensionSubsystem extension, PivotSubsystem pivot, WristSubsystem wrist, IntakeSubsystem intake, DefaultGoToPointCommand gtpc) {
    ...
    public AutonFirstYellow(ExtensionSubsystem extension, PivotSubsystem pivot, WristSubsystem wrist, IntakeSubsystem intake, DefaultGoToPointCommand gtpc, CameraSubsystem cam, PinpointSubsystem pinpoint) {
